...
class CHTCollectionViewWaterfallLayout : UICollectionViewLayout{
    ...
    override func prepare(){
        ...
        self.sectionInset = (delegate?.sectionInsets())!
        ...
        self.columnCount = (delegate?.numberOfCoulom())!
    ...
    override var collectionViewContentSize : CGSize{
        ...
        contentSize.height = CGFloat(height.floatValue)
...
//        
//        
//        attribute?.transform = CGAffineTransform(translationX: -((self.collectionView?.bounds.width)!), y: CGFloat((self.collectionView?.numberOfItems(inSection: 0))!))
//        
